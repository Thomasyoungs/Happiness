...
//        this.setBackgroundImageRes(R.color.common_white);
    ...
    private void initArea(final int layoutId) {
        ...
        if (layout == null) {
            ...
            holder.imageButton = (ImageView) layout.findViewById(R.id.topbar_button);
    ...
    public void showButtonTextWhiteBg(CharSequence text, int layoutId, int bg, int width, int height) {
        RelativeLayout tempLayout = getArea(layoutId);
        tempLayout.setBackgroundResource(R.color.common_transparent);
        TopBarHolder holder = (TopBarHolder) tempLayout.getTag();
        if (!TextUtils.isEmpty(text)) {
            ...
            holder.textView.setBackgroundResource(bg);
            holder.textView.setVisibility(View.VISIBLE);
            LayoutParams params = (LayoutParams) holder.textView.getLayoutParams();
    ...
    public void showButtonText(String text, int layoutId, int colorId, float size) {
        RelativeLayout tempLayout = getArea(layoutId);
        tempLayout.setBackgroundResource(R.color.common_transparent);
        TopBarHolder holder = (TopBarHolder) tempLayout.getTag();
        if (!TextUtils.isEmpty(text)) {
